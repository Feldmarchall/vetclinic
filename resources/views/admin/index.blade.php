        ...
        <div class="row">
            ...
            <div>
              <div class="widget bg-white">
                ...
                <div class="overflow-hidden">
                  <span class="widget-title">34</span>
                  <span class="widget-subtitle">Сотрудников в системе</span>
                </div>
              </div>
              <div class="widget bg-white">
                ...
                <div class="overflow-hidden">
                  <span class="widget-title">425800</span>
                  <span class="widget-subtitle">Выручки за неделю</span>
                </div>
              </div>
              <div class="widget bg-white">
                ...
                <div class="overflow-hidden">
                  <span class="widget-title">467</span>
                  <span class="widget-subtitle">Принятых пациента</span>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="widget-chart bg-white no-padding">
              <div class="row absolute tp lt rt p15">
                <div class="col-xs-12">
                  ...
                  {{--</div>--}}
                  <small class="text-uppercase">Свободных врачей</small>
                  <h4 class="text-primary bold no-margin">4</h4>
                </div>
              </div>
          ...
          <div class="col-md-4">
            <div class="widget-chart bg-white">
              ...
              <div class="row">
                <div class="col-xs-12">
                  <small class="text-uppercase">Пациентов за неделю</small>
                  <h4 class="no-margin bold text-success">15</h4>
                </div>
              </div>
